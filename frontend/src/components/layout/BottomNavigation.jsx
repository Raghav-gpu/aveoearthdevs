  ...
  const navItems = [
    {
      ...
      activeColor: "text-[var(--color-eco-primary)]",
      bgColor: "bg-[var(--color-eco-subtle)]"
    },
    {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center">
      ...
      <div className="safe-area-inset-bottom">
        <div className="glass-green border border-[var(--color-eco-accent)] backdrop-blur-xl shadow-eco-lg rounded-2xl mx-4 mb-4 px-4 py-3">
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive ? `${item.bgColor} ${item.activeColor} shadow-eco` : 'text-[var(--color-eco-secondary)] hover:text-[var(--color-eco-primary)] hover:bg-[var(--color-eco-subtle)]/50'}
              ...
              >
                ...
                <span className={`
                  ...
                  ${isActive ? 'font-semibold text-[var(--color-eco-primary)]' : 'group-hover:font-medium'}
                `}>
                  {item.label}
                </span>
                ...
                {isActive && (
                  <div className="w-1 h-1 bg-[var(--color-eco-primary)] rounded-full mt-1 animate-pulse-glow"></div>
                )}
              </Link>
            );
          })}
